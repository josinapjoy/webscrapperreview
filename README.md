...
#### *  Developed a demo web app to scrape the reviews of the products from an Indian e-commerce website called Flipkart, using
####    flask framework and python libraries such as requests, beautiful soup.
